...
#figure(
  table(
    ...
    stroke: 0.5pt,
    [*Model / Ensemble*], [*Detail*], [*Score*],
    [ConvNeXt-Large (s. 999)], [val], [0.0011],
    [ConvNeXt-Large (s. 123)], [val], [0.0011],
    [ConvNeXtV2-Base (s. 123)], [val], [0.0014],
    [ConvNeXt-Base (s. 42/123)], [val], [0.0016],
    [ConvNeXt-Base (s. 456)], [val], [0.0018],
    [EfficientNet-B4 (s. 123)], [val], [0.0017],
    [ENS3 (3 ConvNeXt)], [leaderboard], [0.00115],
    [s6 (Base + B4)], [leaderboard], [0.00116],
    [ENS4 (4 ConvNeXt)], [leaderboard], [0.00115],
    table.hline(),
    [*Final blend*], [*leaderboard*], [*0.00112*],
  ),
  caption: [Per-model validation scores and leaderboard results.],
)
